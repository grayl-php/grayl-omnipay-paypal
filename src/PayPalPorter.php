 ...
 */
class PayPalPorter extends
    OmnipayPorterAbstract
{
     ...
     * @throws \Exception
     */
    public function newPayPalAuthorizeRequestController(
    ): PayPalAuthorizeRequestController
    {

        // Create the PayPalQueryRequestData entity
        $request_data = new PayPalAuthorizeRequestData(
            'authorize',
            $this->getOffsiteURLs()
        );

        // Return a new PayPalQueryRequestController entity
        return new PayPalAuthorizeRequestController(
     ...
     * @throws \Exception
     */
    public function newPayPalCompleteRequestController(
    ): PayPalCompleteRequestController
    {

        // Create the PayPalQueryRequestData entity
        $request_data = new PayPalCompleteRequestData(
            'confirm',
            $this->getOffsiteURLs()
        );

        // Return a new PayPalQueryRequestController entity
        return new PayPalCompleteRequestController(
            $this->getSavedGatewayDataEntity('default'),
            $request_data,
     ...
     * @throws \Exception
     */
    public function newPayPalCaptureRequestController(
    ): PayPalCaptureRequestController
    {

        // Create the PayPalQueryRequestData entity
        $request_data = new PayPalCaptureRequestData(
            'capture',
            $this->getOffsiteURLs()
        );

        // Return a new PayPalQueryRequestController entity
        return new PayPalCaptureRequestController(
            $this->getSavedGatewayDataEntity('default'),
            $request_data,
