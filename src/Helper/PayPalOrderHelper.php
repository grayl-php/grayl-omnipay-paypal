<?php
    ...
    */
   class PayPalOrderHelper extends OmnipayOrderHelperAbstract
   {
       ...
       * @throws \Exception
       */
      public function newPayPalAuthorizeRequestControllerFromOrder ( OrderController $order_controller ): PayPalAuthorizeRequestController
      {
       ...
       * @throws \Exception
       */
      public function newPayPalCompleteRequestControllerFromOrder ( OrderController $order_controller,
                                                                    string $reference_id,
                                                                    string $payer_id ): PayPalCompleteRequestController
      {
         ...
         PayPalHelper::getInstance()
                     ->translatePayPalPayerID( $request->getRequestData(),
                                               $payer_id );
       ...
       * @throws \Exception
       */
      public function newPayPalCaptureRequestControllerFromOrder ( OrderController $order_controller,
