 ...
 */
class PayPalAuthorizeRequestControllerTest extends
    TestCase
{
     ...
     * @throws \Exception
     */
    public function testCreatePayPalAuthorizeRequestController(
        ...
        // Check the type of object returned
        $this->assertInstanceOf(
            PayPalAuthorizeRequestController::class,
            $request
        );
     ...
     * @throws \Exception
     */
    public function testSendPayPalAuthorizeRequestController(
        PayPalAuthorizeRequestController $request
    ): PayPalAuthorizeResponseController {
        ...
        // Check the type of object returned
        $this->assertInstanceOf(
            PayPalAuthorizeResponseController::class,
            $response
        );
     ...
     */
    public function testPayPalAuthorizeResponseController(
        PayPalAuthorizeResponseController $response
    ): void {
     ...
     * @throws \Exception
     */
    public function testCreateOrderPaymentFromPayPalAuthorizeResponseController(
        OrderController $order_controller,
        PayPalAuthorizeResponseController $response
    ): void {
        ...
        PayPalOrderHelper::getInstance()
            ->newOrderPaymentFromOmnipayResponseController(
                $response,
                $order_controller,
                null
            );
